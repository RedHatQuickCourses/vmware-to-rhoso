...
aap-controller-migration-4.6.8-kls8d         0/1     Completed   0          8m23s
aap-controller-task-78d76d4596-mn8vc         4/4     Running     0          9m7s
aap-controller-web-86f9d988-cvc8h            3/3     Running     0          9m9s
aap-eda-activation-worker-59fd79b5c9-d6vcb   1/1     Running     0          9m32s
aap-eda-activation-worker-59fd79b5c9-hdg92   1/1     Running     0          9m32s
aap-eda-api-864755bcc8-sk87f                 3/3     Running     0          9m34s
aap-eda-default-worker-7d54fdb44c-9ngrc      1/1     Running     0          9m33s
aap-eda-default-worker-7d54fdb44c-dn8xm      1/1     Running     0          9m33s
aap-eda-event-stream-674db468c7-c9xxd        2/2     Running     0          9m29s
aap-eda-scheduler-99dccf864-n7nzc            1/1     Running     0          9m31s
aap-eda-scheduler-99dccf864-skzdj            1/1     Running     0          9m31s
aap-gateway-d9894b76f-dcfn4                  2/2     Running     0          11m
aap-hub-api-668b966979-vb8lq                 1/1     Running     0          9m1s
aap-hub-content-745c569598-47vs9             1/1     Running     0          9m16s
aap-hub-content-745c569598-cdnc4             1/1     Running     0          9m16s
aap-hub-redis-655c475d7c-p5ftl               1/1     Running     0          9m25s
aap-hub-web-57d489786-d5wbt                  1/1     Running     0          9m30s
aap-hub-worker-878857467-g687h               1/1     Running     0          9m11s
aap-postgres-15-0                            1/1     Running     0          12m
aap-redis-0                                  1/1     Running     0          12m
...
[source,bash,role=execute]
----
oc get secret/aap-admin-password -o jsonpath={.data.password} -n aap | base64 --decode ; echo
----
...
[source,bash,role=execute,subs=attributes]
----
aap-aap.apps.cluster-{guid}.dynamic.redhatworkshops.io
----
